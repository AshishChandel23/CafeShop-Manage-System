...
public class ViewSells extends javax.swing.JFrame {
    ...
    private void showProducts(){
        try {
            ...
            pre = con.prepareStatement("Select * from Bills");
            ResultSet rs = pre.executeQuery();
            ResultSetMetaData rsmd =  rs.getMetaData();
            int coulmnCount = rsmd.getColumnCount();
            DefaultTableModel dft = (DefaultTableModel) sells.getModel();
            dft.setRowCount(0);
            while(rs.next()){
                Vector v2 = new Vector();
                for(int i=1;i<=coulmnCount;i++){
                    v2.add(rs.getString("BillId"));
    ...
    private void initComponents() {
        ...
        sells.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        sells.setForeground(new java.awt.Color(255, 51, 102));
        sells.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Bill Id", "Seller", "Items", "Amount", "Date"
            }
        ));
        sells.setInheritsPopupMenu(true);
        sells.setRowHeight(28);
        sells.setShowHorizontalLines(true);
